...
vott_data = None
pascal_path = '/home/zb/works/test/trafficlight/pascal/VOCdevkit/VOC2012'
pascal_anno_path = f'{pascal_path}/Annotations'
pascal_main_path = f'{pascal_path}/ImageSets/Main'
...
for p in [pascal_anno_path, pascal_main_path, pascal_jpg_path]:
    os.makedirs(p)
